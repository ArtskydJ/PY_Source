a='sbkAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT\
...
for i in range(65,90,1):
    a.replace(a,chr(i),"b") #big

for i in range(97,122,1):
    a.replace(a,chr(i),"s") #small
    
print(a)
b0=a.index("sbbbsbbbs")
b1=a.index("sbbbsbbbs")
b2=a.index("sbbbsbbbs")
b3=a.index("sbbbsbbbs")
b4=a.index("sbbbsbbbs")
b5=a.index("sbbbsbbbs")
b6=a.index("sbbbsbbbs")
b7=a.index("sbbbsbbbs")
b8=a.index("sbbbsbbbs")
b9=a.index("sbbbsbbbs")
